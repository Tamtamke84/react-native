...
const RawNativeDOM = (TurboModuleRegistry.getEnforcing<Spec>(
  'NativeDOMCxx',
): Spec);
...
const NativeDOM: RefinedSpec = {
  getParentNode(shadowNode) {
    ...
    return RawNativeDOM.getParentNode(shadowNode) as ?InstanceHandle;
  },

  getChildNodes(shadowNode) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getChildNodes(
      shadowNode,
    ) as ?$ReadOnlyArray<InstanceHandle>;
  },

  isConnected(shadowNode) {
    return RawNativeDOM.isConnected(shadowNode);
  },

  compareDocumentPosition(shadowNode, otherShadowNode) {
    return RawNativeDOM.compareDocumentPosition(shadowNode, otherShadowNode);
  },

  getTextContent(shadowNode) {
    return RawNativeDOM.getTextContent(shadowNode);
  },

  getBoundingClientRect(shadowNode, includeTransform: boolean) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getBoundingClientRect(
      shadowNode,
      includeTransform,
    ) as ?$ReadOnly<
      [
  ...
  getOffset(shadowNode) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getOffset(shadowNode) as ?$ReadOnly<
      [
  ...
  getScrollPosition(shadowNode) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getScrollPosition(shadowNode) as ?$ReadOnly<
  ...
  getScrollSize(shadowNode) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getScrollSize(shadowNode) as ?$ReadOnly<
  ...
  getInnerSize(shadowNode) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getInnerSize(shadowNode) as ?$ReadOnly<
  ...
  getBorderSize(shadowNode) {
    // $FlowExpectedError[incompatible-cast]
    return RawNativeDOM.getBorderSize(shadowNode) as ?$ReadOnly<
      [
        /* topWidth: */ number,
        /* rightWidth: */ number,
        /* bottomWidth: */ number,
  ...
  getTagName(shadowNode) {
    return RawNativeDOM.getTagName(shadowNode);
  },

  hasPointerCapture(shadowNode, pointerId) {
    return RawNativeDOM.hasPointerCapture(shadowNode, pointerId);
  },

  setPointerCapture(shadowNode, pointerId) {
    return RawNativeDOM.setPointerCapture(shadowNode, pointerId);
  },

  releasePointerCapture(shadowNode, pointerId) {
    return RawNativeDOM.releasePointerCapture(shadowNode, pointerId);
  },
};
